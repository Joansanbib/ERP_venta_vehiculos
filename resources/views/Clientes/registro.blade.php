...
<form id="form" action="/clientes/create" method="post" class="max-w-lg mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 m-10">
   @csrf
   <div class="mb-7">
      <label class="block text-black text-lg font-bold mb-4" for="cliente_name">Nombre:</label>
   ...
   <div class="mb-7">
      <label class="block text-black text-lg font-bold mb-4" for="cliente_apellido">Apellidos:</label>
   ...
   <div class="mb-7">
      <label class="block text-black text-lg font-bold mb-4" for="cliente_email">Email:</label>
   ...
   <div class="mb-7">
      <label class="block text-black text-lg font-bold mb-4" for="cliente_pass">Contraseña: </label>
   ...
   <div class="mb-7">
      <label class="block text-black text-lg font-bold mb-4" for="cliente_tel">Teléfono:</label>
   ...
   <div class="mb-7">
      <label class="block text-black text-lg font-bold mb-4" for="cliente_dir">Dirección:</label>
   ...
   <div class="mb-7">
      <label class="block text-black text-lg font-bold mb-4" for="cliente_pob">Población (nombre):</label>
