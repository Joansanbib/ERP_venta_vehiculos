...
<form id="form" action="/clientes/{{$cliente->ClienteID}}/update" method="post" class="max-w-md mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
   @csrf
   <div class="mb-4">
   ...
   <div class="mb-4">
      <label class="block text-black text-sm font-bold mb-2" for="editApellido">Apellido:</label>
   ...
   <div class="mb-4">
      <label class="block text-black text-sm font-bold mb-2" for="editEmail">Email:</label>
   ...
   <div class="mb-4">
      <label class="block text-black text-sm font-bold mb-2" for="editTel">Teléfono:</label>
   ...
   <div class="mb-4">
      <label class="block text-black text-sm font-bold mb-2" for="editDir">Dirección:</label>
   ...
   <div class="mb-4">
      <label class="block text-black text-sm font-bold mb-2" for="editContra">Contraseña:</label>
   ...
   <div class="mb-4">
      <label class="block text-black text-sm font-bold mb-2" for="editPob">Población:</label>
   ...
   <div class="mb-4">
    <label class="block text-black text-sm font-bold mb-2" for="editRol">Rol:</label>
